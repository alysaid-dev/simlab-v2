...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "aspect-square size-4 shrink-0 rounded-full border transition-colors outline-none",
        "border-gray-400 bg-white",
        "data-[state=checked]:border-blue-900 data-[state=checked]:bg-blue-900",
        "focus-visible:ring-2 focus-visible:ring-blue-900 focus-visible:ring-offset-2",
